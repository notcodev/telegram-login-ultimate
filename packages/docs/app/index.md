...
hero:
  name: 'Telegram Login Ultimate'
  text: 'Telegram Login API integration tools'
...
features:
  ...
  - title: Lightweight
    details: Telegram Login Ultimate is lightweight and easy to integrate into your project.
